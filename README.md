...
- 16 scales including modes, pentatonics, blues, diminished, whole tone
- Dark graphite fretboard with root / scale / focus-degree colors
- Click scale degrees to highlight target tones
- Chord-type library in the current key (in-scale chords are brighter)
